...
/* Define to 1 if you have the declaration of `IBV_ATOMIC_HCA', and to 0 if
   you don't. */
#define HAVE_DECL_IBV_ATOMIC_HCA 1
...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -mcx16 -pthread -D__EXTENSIONS__' CPPFLAGS='   ' FFLAGS='' LDFLAGS='   ' --enable-shared --disable-static  --prefix=/home/ydy/local/packages/OpenMPI-4.0.7 --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OMPI_TARBALL_VERSION "4.0.7"
...
/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION_STR 9.4.0
...
#define OPAL_HAVE_RDMACM 0

/* Enable RDMAoE support */
#define OPAL_HAVE_RDMAOE 1
...
#define OPAL_IBV_CREATE_CQ_ARGS 5

/* ident string for Open MPI */
#define OPAL_IDENT_STRING "4.0.7"
...
#define OPAL_PACKAGE_STRING "Open MPI ydy@eclgpu4 Distribution"
...
#define OPAL_RELEASE_DATE "Nov 12, 2021"
...
#define OPAL_TARBALL_VERSION "4.0.7"
...
#define ORTE_RELEASE_DATE "Nov 12, 2021"
...
#define OSHMEM_TARBALL_VERSION "4.0.7"
...
#define PACKAGE_STRING "Open MPI 4.0.7"
...
#define WRAPPER_EXTRA_LIBS "-lhwloc -ldl -levent_core -levent_pthreads -lutil -lm  -lrt -lz"
