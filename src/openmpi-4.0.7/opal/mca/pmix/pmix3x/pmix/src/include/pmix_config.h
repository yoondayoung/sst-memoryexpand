...
/* The compiler $lower which PMIx was built with */
#define PMIX_BUILD_PLATFORM_COMPILER_VERSION 590848

/* The compiler $lower which PMIx was built with */
#define PMIX_BUILD_PLATFORM_COMPILER_VERSION_STR 9.4.0

/* OMPI underlying C compiler */
#define PMIX_CC "gcc"

/* Capture the configure cmd line */
#define PMIX_CONFIGURE_CLI " \'--disable-man-pages\' \'--disable-debug\' \'--with-pmix-symbol-rename=OPAL_MCA_PMIX3X_\' \'--enable-embedded-mode\' \'--disable-pmix-timing\' \'--without-tests-examples\' \'--disable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--enable-embedded-libevent\' '--with-libevent-header=\"opal/mca/event/external/external.h\"' \'--enable-embedded-hwloc\' '--with-hwloc-header=\"opal/mca/hwloc/external/external.h\"' \'--prefix=/home/ydy/local/packages/OpenMPI-4.0.7\' \'CFLAGS=-O3 -DNDEBUG  \' \'CPPFLAGS=-I/home/ydy/scratch/src/openmpi-4.0.7 -I/home/ydy/scratch/src/openmpi-4.0.7 -I/home/ydy/scratch/src/openmpi-4.0.7/opal/include -I/home/ydy/scratch/src/openmpi-4.0.7/opal/include    \' \'--cache-file=/dev/null\' \'--srcdir=.\' \'--disable-option-checking\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "2023-02-15T21:51:31"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "eclgpu4"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "ydy"
...
#define PMIX_PACKAGE_STRING "PMIx ydy@eclgpu4 Distribution"
